...
const navlinks = [
    { id: 1, name: 'Overview', to: '/' },
    { id: 2, name: 'Criptomonedas', to: '/currencies' },
    { id: 3, name: 'Intercambios', to: '/exchanges' },
    { id: 4, name: 'Noticias', to: '/news' },
]
